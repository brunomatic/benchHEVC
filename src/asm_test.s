...
dct32_16:
    ...
    mov r4, sp				// buffer pointer for second pass
...
.loop1:
	...
	mov r12, r3
	add r12, #32*2*4				// start from row 4
	mov lr, #32*2*8					// column stride for storing
	...
	mov r12, r3
	add r12, #32*2*2				// start from row 2
...
//****************CHECKPOINT - up to this point everything is checked and working fine
	...
	mov r12, r3
	add r12, #32*2*1					// start from row 1
	...
	vst1.16	{d5}, [r12], lr
	vst1.16	{d6}, [r12], lr
	vst1.16	{d7}, [r12], lr		// pointer stops on row 9
	...
	vst1.16	{d5}, [r12], lr
	vst1.16	{d6}, [r12], lr
	vst1.16	{d7}, [r12], lr		// pointer stops on row 17
	...
	vst1.16	{d5}, [r12], lr
	vst1.16	{d6}, [r12], lr
	vst1.16	{d7}, [r12], lr		// pointer stops on row 25
	...
	mov r2, #32/4			// rows counter
	mov r0, r4				// read from stack buffer for sceond pass
...
.loop2:
	...
	mov lr, #32*2*8					// column stride for storing
    vqrshrn.s32	d8, q15, #11			// d8 => dst[16]
    vqrshrn.s32 d9, q13, #11			// d9 => dst[24]
    vqrshrn.s32	d14, q14, #11		// d14=> dst[0]
    vqrshrn.s32	d15, q12, #11		// d15=> dst[8]
	...
	mov lr, #32*2*8					// column stride for storing
    vqrshrn.s32	d8, q12, #11			// d8 => dst[4]
    vqrshrn.s32 d9, q13, #11			// d9 => dst[12]
    vqrshrn.s32	d14, q14, #11		// d14 => dst[20]
    vqrshrn.s32	d15, q15, #11		// d15 => dst[28]
	...
	vqrshrn.s32	d12, q12, #11		// d12 => dst[2]
    vqrshrn.s32 d13, q13, #11		// d13 => dst[6]
    vqrshrn.s32	d14, q14, #11		// d14 => dst[10]
    vqrshrn.s32	d15, q15, #11		// d15 => dst[14]
	...
	vqrshrn.s32	d12, q12, #11		// d12 => dst[18]
    vqrshrn.s32 d13, q13, #11		// d13 => dst[22]
    vqrshrn.s32	d14, q14, #11		// d14 => dst[26]
    vqrshrn.s32	d15, q15, #11		// d15 => dst[30]
	...
	vqrshrn.s32	d4, q12, #11		// d4 => dst[1]
    vqrshrn.s32 d5, q13, #11		// d5 => dst[3]
    vqrshrn.s32	d6, q14, #11		// d6 => dst[5]
    vqrshrn.s32	d7, q15, #11		// d7 => dst[7]
	...
	vqrshrn.s32	d4, q12, #11		// d4 => dst[9]
    vqrshrn.s32 d5, q13, #11		// d5 => dst[11]
    vqrshrn.s32	d6, q14, #11		// d6 => dst[13]
    vqrshrn.s32	d7, q15, #11		// d7 => dst[15]
	...
	vqrshrn.s32	d4, q12, #11		// d4 => dst[9]
    vqrshrn.s32 d5, q13, #11		// d5 => dst[19]
    vqrshrn.s32	d6, q14, #11		// d6 => dst[21]
    vqrshrn.s32	d7, q15, #11		// d7 => dst[23]
	...
	vqrshrn.s32	d4, q12, #11		// d4 => dst[9]
    vqrshrn.s32 d5, q13, #11		// d5 => dst[27]
    vqrshrn.s32	d6, q14, #11		// d6 => dst[29]
    vqrshrn.s32	d7, q15, #11		// d7 => dst[31]
